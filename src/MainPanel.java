...
public class MainPanel extends JPanel implements MouseListener, KeyListener, ActionListener {
	...
	public MainPanel(Frame f, Client c, Document user) {
		...
		logout.setFont(new Font("SansSerif", Font.ITALIC, 20));
		exit = new JMenuItem("logout");
		exit.setFont(new Font("SansSerif", Font.ITALIC, 20));
		logout.add(exit);
		exit.addActionListener(this);
		deleteAccount = new JMenu("delete account");
		deleteAccount.setFont(new Font("SansSerif", Font.ITALIC, 20));
		delete = new JMenuItem("delete account");
		delete.setFont(new Font("SansSerif", Font.ITALIC, 20));
		...
		ask.setFont(new Font("SansSerif", Font.ITALIC, 30));
		ask.setPreferredSize(d1);
		ask.addMouseListener(this);
		ask.addActionListener(this);

		search = new JButton("search");
		search.setFont(new Font("SansSerif", Font.ITALIC, 30));
		...
		answermark.setFont(new Font("SansSerif", Font.ITALIC, 30));
		...
		answeredit.setFont(new Font("SansSerif", Font.ITALIC, 30));
