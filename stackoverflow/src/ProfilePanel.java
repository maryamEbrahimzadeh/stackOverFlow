...
public class ProfilePanel extends JPanel implements MouseListener, KeyListener {
    ...
    public ProfilePanel (Frame f, Client c,Document user) {
        this.f = f;
        this.c = c;
        this.user = user;
        Dimension d = Toolkit.getDefaultToolkit().getScreenSize();
...
//        option4.addActionListener(listener);
        ...
        proEdit = new JButton("Edit profile");
        Dimension d1 = new Dimension(d.width / 15, d.height / 30);
        proEdit.setPreferredSize(d1);
        proEdit.addMouseListener(this);
        p3.add(proEdit);
        p3.setVisible(true);
        p0.add(p3);
...
//          
            ...
            c.sendMessage(new Message(Message.UPDATEPRO, doc,user));
            f.setVisible(true);
            c.mp.setVisible(true);
