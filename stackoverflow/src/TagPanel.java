...
public class TagPanel extends JPanel implements MouseListener, KeyListener, ActionListener {
	...
	public TagPanel(Frame f, Client c, Document user) {
		...
		tagstext = new JTextArea("tags:\n");
		tagstext.setFont(new Font("SansSerif", Font.ITALIC, 20));
	...
	public void mousePressed(MouseEvent e) {
		 if (e.getSource() == exit) {
				...
				c.mp.display.setText("");
				c.sendMessage(new Message(Message.SHOWTHISTAG,tag.getText()));
